<div id="postContainer">
        ...
        $selectUserPost = new PostView();
        $userPosts = $selectUserPost -> getUserPost($userID, $postOffset, $postLimit);
        $userPostCount = $selectUserPost -> getUserPostCount($userID);
        ?>
            ...
            $(document).ready(function(){
                ...
                $("#showMorePosts").click(function(){
                    ...
                    function(data){
                        ...
                        if(postOffset + 5 >= <?php echo count($userPostCount); ?>){
        ...
        ?>
            ...
            <div class="post-container" id="postContainer<?php echo $postID ?>">
                ...
                <div class="post-text-container">
                    <pre><?php echo $userPost["PostText"] ?></pre>
                </div>
                ...
                <div class="post-interact">
                    ...
                    <script>
                        ...
                        $(document).ready(function(){
                            ...
                            var likeCount = <?php echo $userPost["Likes"]?>;
                ...
                <div id="commentSection<?php echo $postID ?>" class="comment-section">
                 ...
                 <form class="comment-form" id="commentForm<?php echo $postID ?>" action="action/commentAction.php" method="post">
                    ...
                    if($userPost["Comments"] > $commentLimit ){
