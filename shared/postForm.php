...
<a class="post-user-container" href=<?php echo "/page/profile.php?userID=".$_SESSION["user_id"]?>>
    <img src=<?php echo "/user/".$_SESSION["user_id"]."/profileImage.jpg?a=".$time ?> alt="">
    <div><?php echo $_SESSION["username"] ?></div>
</a>

<div class="post-text-input">
    <textarea name="postText" id="postText" rows="1" placeholder="What's Happening?"></textarea>
</div>
